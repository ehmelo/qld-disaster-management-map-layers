...
|---|---|---|---|---|---|
| `qld_ddmg_boundaries_gda2020_simp200m` | 23 | 436 KB | 158 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_ldmg_boundaries_gda2020_simp200m` | 78 | 843 KB | 324 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| Layer | Features | GeoJSON | TopoJSON | Match field | Coordinates |
|---|---|---|---|---|---|
| `qld_dm_region_boundaries_gda2020_simp200m` | 7 | 253 KB | 99 KB | `Police Region Short Name` | GDA2020 (EPSG:7844) |
...
| Layer | Features | GeoJSON | TopoJSON | Match field | Coordinates |
|---|---|---|---|---|---|
| `qld_brisbane_ddmg_boundaries_gda2020_simp200m` | 2 | 16 KB | 10 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_brisbane_ldmg_boundaries_gda2020_simp200m` | 3 | 19 KB | 13 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_central_ddmg_boundaries_gda2020_simp200m` | 4 | 114 KB | 49 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_central_ldmg_boundaries_gda2020_simp200m` | 14 | 197 KB | 80 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_far_north_ddmg_boundaries_gda2020_simp200m` | 3 | 82 KB | 39 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_far_north_ldmg_boundaries_gda2020_simp200m` | 21 | 243 KB | 107 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_north_coast_ddmg_boundaries_gda2020_simp200m` | 4 | 52 KB | 27 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_north_coast_ldmg_boundaries_gda2020_simp200m` | 8 | 76 KB | 38 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_northern_ddmg_boundaries_gda2020_simp200m` | 2 | 58 KB | 34 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_northern_ldmg_boundaries_gda2020_simp200m` | 16 | 150 KB | 71 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_south_east_ddmg_boundaries_gda2020_simp200m` | 2 | 14 KB | 9 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_south_east_ldmg_boundaries_gda2020_simp200m` | 3 | 20 KB | 12 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_southern_ddmg_boundaries_gda2020_simp200m` | 6 | 101 KB | 49 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_southern_ldmg_boundaries_gda2020_simp200m` | 13 | 140 KB | 67 KB | `LDMG Name` | GDA2020 (EPSG:7844) |

### Official QPS boundaries (for comparison)

| Layer | Features | GeoJSON | TopoJSON | Match field | Coordinates |
|---|---|---|---|---|---|
| `qld_qps_regions_gda94_simp200m` | 7 | 236 KB | 89 KB | `QPS Region` | GDA94 (EPSG:4283) |
| `qld_qps_districts_gda94_simp200m` | 15 | 314 KB | 114 KB | `QPS District` | GDA94 (EPSG:4283) |
...
`https://ehmelo.github.io/qld-disaster-management-map-layers/releases/2026-09-13/`. Bind a report to `layers/` to follow
