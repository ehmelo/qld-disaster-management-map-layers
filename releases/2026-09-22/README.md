...
Generated 22/09/2026. Layer metadata, including sources and
...
| `qld_ldmg_boundaries_gda2020_simp200m` | 78 | 862 KB | 370 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| `qld_central_ldmg_boundaries_gda2020_simp200m` | 14 | 198 KB | 90 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_far_north_ddmg_boundaries_gda2020_simp200m` | 3 | 82 KB | 44 KB | `DDMG Name` | GDA2020 (EPSG:7844) |
| `qld_far_north_ldmg_boundaries_gda2020_simp200m` | 21 | 258 KB | 126 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| `qld_southern_ldmg_boundaries_gda2020_simp200m` | 13 | 141 KB | 74 KB | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| Layer | Features | GeoJSON | TopoJSON | Match field | Coordinates |
|---|---|---|---|---|---|
| `qld_ldmg_boundaries_gda2020_simp200m_schematic` | 78 | 874 KB | none (GeoJSON only) | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| `qld_northern_ldmg_boundaries_gda2020_simp200m_schematic` | 16 | 157 KB | none (GeoJSON only) | `LDMG Name` | GDA2020 (EPSG:7844) |
| `qld_south_east_ldmg_boundaries_gda2020_simp200m_schematic` | 3 | 21 KB | none (GeoJSON only) | `LDMG Name` | GDA2020 (EPSG:7844) |
...
| `qld_qps_districts_gda94_simp200m` | 15 | 315 KB | 130 KB | `QPS District` | GDA94 (EPSG:4283) |
...
`https://ehmelo.github.io/qld-disaster-management-map-layers/releases/2026-09-22/`. Bind a report to `layers/` to follow
